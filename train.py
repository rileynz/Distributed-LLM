...
def get_batch(data, block_size, batch_size, device):
    ...
    # When the data is exactly block_size+1 chars, max_start is 0 and
    # there's exactly one valid window (starting at index 0) — guard
    # against torch.randint(0, 0, ...), which raises rather than just
    # returning that single valid index every time.
